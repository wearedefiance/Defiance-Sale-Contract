...
/**
 * @title Token
 * @dev API interface for interacting with the DEF Token contract
 */
interface Token {
...
/**
 * @title DefICO
 * @dev DefICO contract is Ownable
 **/
contract DefICO is Ownable {
  using SafeMath for uint256;
  Token token;

  uint256 public constant RATE = 200000; // Number of tokens per Ether
  uint256 public constant CAP = 500; // Cap in Ether
  uint256 public constant START = 1597669200; // Mar 26, 2018 @ 12:00 EST
  ...
  /**
   * DefICO
   * @dev DefICO constructor
   **/
  function DefICO(address _tokenAddr) public {
